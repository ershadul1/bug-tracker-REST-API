    ...
    class AssignsController < ApplicationController
      def create
        ...
        if assign.valid?
          ...
          render json: {status: 'ERROR', message:'Bug not assigned', data: assign.errors },status: :unprocessable_entity
        end
      end
      ...
      def destroy
        ...
        if assign.destroy
          ...
          render json: {status: 'ERROR', message:'Assign not destroyed', data: assign.errors },status: :unprocessable_entity
        end
      end
