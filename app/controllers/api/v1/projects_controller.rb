    ...
    class ProjectsController < ApplicationController
      ...
      def create
        ...
        if project.valid?
          ...
          render json: {status: 'ERROR', message:'Project not created', data: project.errors },status: :unprocessable_entity
        end
      end
      ...
      def destroy
        ...
        if project.destroy
          ...
          render json: {status: 'ERROR', message:'Project not destroyed', data: project.errors },status: :unprocessable_entity
        end
      end
